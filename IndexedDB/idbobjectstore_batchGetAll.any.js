...
function batchgetall_test(storeName, func, name) {
    indexeddb_test(
        (t, connection, tx) => {
            ...
            switch (storeName) {
                case 'generated':
                    store = connection.createObjectStore('generated', { autoIncrement: true, keyPath: 'id' });
...
batchgetall_test('out-of-line', (t, connection) => {
    ...
    req.onsuccess = t.step_func(evt => {
        assert_equals(JSON.stringify(evt.target.result), JSON.stringify([
            ['value-c']
        ]));
        t.done();
    });
...
batchgetall_test('out-of-line', (t, connection) => {
    const req = createBatchGetAllRequest(t, 'out-of-line', connection, [IDBKeyRange.bound('a', 'z')], 5);
    req.onsuccess = t.step_func(evt => {
        assert_equals(JSON.stringify(evt.target.result), JSON.stringify([
...
batchgetall_test('out-of-line', (t, connection) => {
    const req = createBatchGetAllRequest(t, 'out-of-line', connection, [IDBKeyRange.bound('a', 'e')]);
    req.onsuccess = t.step_func(evt => {
        assert_equals(JSON.stringify(evt.target.result), JSON.stringify([
            ['value-a', 'value-b', 'value-c', 'value-d', 'value-e']
        ]));
...
batchgetall_test('out-of-line', (t, connection) => {
    const req = createBatchGetAllRequest(t, 'out-of-line', connection, [IDBKeyRange.bound('g', 'k', false, true),
...
batchgetall_test('generated', (t, connection) => {
    const req = createBatchGetAllRequest(t, 'generated', connection, [IDBKeyRange.bound(4, 15),
        IDBKeyRange.bound(5, 15)
    ], 3);
    req.onsuccess = t.step_func(evt => {
