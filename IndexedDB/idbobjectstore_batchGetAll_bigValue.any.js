...
const values = Array.from(keys, (item, index) =>
    largeValue(wrapThreshold, index));
...
batchgetall_test('out-of-line', (t, connection) => {
    ...
    req.onsuccess = t.step_func(evt => {
        assert_equals(JSON.stringify(evt.target.result),
            JSON.stringify([
                [values[2]]
            ]));
        t.done();
...
batchgetall_test('out-of-line', (t, connection) => {
    const req = createBatchGetAllRequest(t, 'out-of-line', connection, [1, 'a', 4, 'z']);
    req.onsuccess = t.step_func(evt => {
        assert_equals(JSON.stringify(evt.target.result),
            JSON.stringify([
                [values[1]],
...
batchgetall_test('out-of-line', (t, connection) => {
    const req = createBatchGetAllRequest(t, 'out-of-line', connection, [IDBKeyRange.bound(0, 10)], 5);
    req.onsuccess = t.step_func(evt => {
        assert_equals(JSON.stringify(evt.target.result),
            JSON.stringify([
...
batchgetall_test('out-of-line', (t, connection) => {
    const req = createBatchGetAllRequest(t, 'out-of-line', connection, [IDBKeyRange.bound(0, 4)]);
    req.onsuccess = t.step_func(evt => {
        assert_equals(JSON.stringify(evt.target.result),
            JSON.stringify([
                [values[0], values[1], values[2],
...
batchgetall_test('out-of-line', (t, connection) => {
    const req = createBatchGetAllRequest(t, 'out-of-line', connection, [IDBKeyRange.bound(0, 4, false, true),
        IDBKeyRange.bound(0, 4, true, false)
    ]);
    req.onsuccess = t.step_func(evt => {
        assert_equals(JSON.stringify(evt.target.result),
            JSON.stringify([
...
batchgetall_test('out-of-line', (t, connection) => {
    const req = createBatchGetAllRequest(t, 'out-of-line', connection, [IDBKeyRange.bound(1, 4)], 0);
    req.onsuccess = t.step_func(evt => {
        assert_equals(JSON.stringify(evt.target.result),
            JSON.stringify([
                [values[1], values[2],
